...
package eu.aldin.mirge.mirgem.block;
...
public class GreenBlockBlock extends MirgemModElements.ModElement {
	@ObjectHolder("mirgem:green_block")
	public static final Block block = null;
	public GreenBlockBlock(MirgemModElements instance) {
		super(instance, 16);
	}
