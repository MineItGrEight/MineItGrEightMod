...
import eu.aldin.mirge.mirgem.procedures.LightningBlockProcedureProcedure;
...
public class LightningBlockBlock extends MirgemModElements.ModElement {
	@ObjectHolder("mirgem:lightning_block")
	public static final Block block = null;
	public LightningBlockBlock(MirgemModElements instance) {
		super(instance, 9);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mirgem:lightning_block_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mirgem:lightning_block"), configuredFeature);
		}
	}
	@SubscribeEvent
