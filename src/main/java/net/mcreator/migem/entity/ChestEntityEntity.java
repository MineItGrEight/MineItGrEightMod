...
package net.mcreator.migem.entity;
...
import net.mcreator.migem.gui.ChestEntityGuiGui;
...
public class ChestEntityEntity extends MigemModElements.ModElement {
	public static EntityType entity = null;
	public ChestEntityEntity(MigemModElements instance) {
		super(instance, 14);
			...
			RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelChest_Entity(), 0.5f) {
					...
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("migem:textures/chest_entity.png");
					}
				};
			});
		}
	...
	public static class CustomEntity extends TameableEntity {
				...
				if (sourceentity instanceof ServerPlayerEntity) {
					NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
						...
						public ITextComponent getDisplayName() {
							return new StringTextComponent("Chest Entity");
						}
						...
						public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
							...
							return new ChestEntityGuiGui.GuiContainerMod(id, inventory, packetBuffer);
						}
					}, buf -> {
		...
		public boolean isBreedingItem(ItemStack stack) {
			if (stack == null)
				return false;
			if (new ItemStack(Blocks.CHEST, (int) (1)).getItem() == stack.getItem())
				return true;
			return false;
		}
